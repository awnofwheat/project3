...
Primary
    ...
    | READ '(' ')'			{pushStack(three_address_code_stack, $1);symbl_tbl_insrt(constant_table, $1, -1, "int", "", yylineno); trace("READ\n");}
    ;
...
Function_Call
    :  WRITE '(' INDENTIFER ')' {symbl_tbl_insrt(symbol_table, $1, curr_scope->scope_num, "Write", "", yylineno);trace("write\n"); }
